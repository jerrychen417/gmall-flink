...
import com.atguigu.gmall.realtime.func.SplitFunction;
...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        String groupId = "keyword_stats_app_2107";
        ...
        Table splitTbale = tableEnv.sqlQuery("" +
                "select " +
                "   word, " +
                "   rt " +
                "from filter_table, lateral table(SplitFunction(keywords))");

        tableEnv.createTemporaryView("split_table", splitTbale);
