...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        //todo 4.安装Mid分组
        KeyedStream<JSONObject, String> keyedStream = jsonObjDS.keyBy(josn -> josn.getJSONObject("common").getString("mid"));
        ...
        //todo 6.将数据写入Kafka
        filterDS.print(">>>>>>>>>>>>");
        filterDS.map(json -> json.toJSONString()).addSink(MyKafkaUtil.getKafkaSink(sinkTopic));
