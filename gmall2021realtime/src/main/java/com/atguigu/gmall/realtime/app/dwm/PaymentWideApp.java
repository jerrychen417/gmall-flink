...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        //todo 5.双流JOIN
        SingleOutputStreamOperator<PaymentWide> payMentWideDS = paymentInfoWithWMDS.keyBy(payInfo -> payInfo.getOrder_id())
                .intervalJoin(orderWideWithWMDS.keyBy(order -> order.getOrder_id()))
